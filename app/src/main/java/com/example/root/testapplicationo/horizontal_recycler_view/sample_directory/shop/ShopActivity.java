package com.example.root.testapplicationo.horizontal_recycler_view.sample_directory.shop;
...
import com.example.root.testapplicationo.horizontal_recycler_view.DSVOrientation;
...
import com.example.root.testapplicationo.horizontal_recycler_view.InfiniteScrollAdapter;
...
public class ShopActivity extends AppCompatActivity implements DiscreteScrollView.OnItemChangedListener,
    ...
    private void changeRateButtonState(Item item) {
        if (shop.isRated(item.getId())) {
            rateItemButton.setImageResource(R.drawable.b);
            rateItemButton.setColorFilter(ContextCompat.getColor(this, R.color.black));
        } else {
            rateItemButton.setImageResource(R.drawable.afghanistan);
            rateItemButton.setColorFilter(ContextCompat.getColor(this, R.color.background));
        }
    }
